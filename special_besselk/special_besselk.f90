...
!     COMPLEX CY,Z
      ...
      FNU, FNUL, RL, R1M5, TOL, UFL, ZI, ZR, DEXP, BB
...
!    *C1,C2,PHI,PHID,RZ,SUM,SUMD,S1,S2,Y,Z,ZETA1,ZETA1D,ZETA2,ZETA2D,ZR
      ...
      CONEI, CONER, CRSC, CSCL, CSGNI, CSPNI, CSPNR, CSR, CSRR, CSSR,  &
      ...
      ZET1DI, ZET1DR, ZET2DI, ZET2DR, ZI, ZR, ZRI, ZRR
      INTEGER I, IB, IFLAG, IFN, IL, INIT, INU, IUF, K, KDFLG, KFLAG,  &
      KK, KODE, MR, N, NW, NZ, INITD, IC, IPARD, J
      DIMENSION BRY(3), INIT(2), YR(1), YI(1), SUMR(2), SUMI(2),       &
...
!    *S1,S2,Y,Z,ZB,ZETA1,ZETA1D,ZETA2,ZETA2D,ZN,ZR
      ...
      CONEI, CONER, CRSC, CR1I, CR1R, CR2I, CR2R, CSCL, CSGNI, CSI,   &
...
!    *S1,S2,Y,Z,ZN
      ...
      CKR, CONEI, CONER, CPN, CSCL, CSCR, CSGNI, CSGNR, CSPNI, CSPNR,  &
...
!
      ...
      TOL, TTH, T1, T2, YI, YR, ZI, ZR, DGAMLN, ELM, CELMR, ZDR, ZDI, &
	  AS, ALAS, HELIM, CYR, CYI
...
!                 MATH. SOFTWARE, 1986
!
!***ROUTINES CALLED  ZACAI,ZBKNU,ZABS,ZEXP,ZSQRT,I1MACH,D1MACH
!***END PROLOGUE  ZAIRY
